...
const USDC_ETHEREUM_MAINNET_CONTRACT = process.env.USDC_ETHEREUM_MAINNET_CONTRACT;
...
const getUSDCBalance = async (wallet) => {
    ...
    const contract = new ethers.Contract(SDC_ETHEREUM_MAINNET_CONTRACT, abi, wallet);
