...
export default async function (req, res) {
    ...
    const sender_wallet = new ethers.Wallet(EUROC_SENDER_PRIVATE_KEY, provider);
    ...
    try {
        ...
        const contract = new ethers.Contract(EUROC_ETHEREUM_MAINNET_CONTRACT, abi, sender_wallet);

        const transaction = await contract.transfer(receiver, value);

        console.log(transaction);

        console.log(`Sent ${ethers.utils.formatUnits(value, 6)} EUROC to ${receiver}`);
